 ...
 */
final class Version20260515103325 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ingredient (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL, categorie_id INT DEFAULT NULL, INDEX IDX_6BAF7870BCF5E72D (categorie_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE note (id INT AUTO_INCREMENT NOT NULL, description1 VARCHAR(255) NOT NULL, recette_id INT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_CFBDFA1489312FE9 (recette_id), INDEX IDX_CFBDFA14A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE recette (id INT AUTO_INCREMENT NOT NULL, description3 LONGTEXT NOT NULL, fiche VARCHAR(255) NOT NULL, avatar2 VARCHAR(255) NOT NULL, moderated_by_id INT DEFAULT NULL, INDEX IDX_49BB63908EDA19B0 (moderated_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
